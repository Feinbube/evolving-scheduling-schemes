...
namespace SchedulingQuest
{
    class Optimums
    {
        public static List<Scheduler> Schedulers()
        {
            ...
            schedulers.Add(new ConfigurableSchedulerM((t, m) => t.AD * t.AD * t.AD * t.S / Math.Pow(t.S, 1.0 / m), "AD³*S/S^(1.0/m)"));
            schedulers.Add(new ConfigurableSchedulerM((t, m) => Math.Pow(1.0 / t.D, 1.0 / (t.AD * t.AD * t.AD * t.S * t.S * t.U)), "(1.0/D)^(AD³*S²*U)"));
            ...
            schedulers.Add(new ConfigurableSchedulerM((t, m) => (t.A*t.S-m+t.S)*t.AD*t.AD, "(A*S-m+S)*AD²"));
